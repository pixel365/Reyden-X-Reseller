...
class TwitchView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs) -> dict[str, Any]:
        ...
        if self.request.user.has_perm(Perms.CAN_CREATE_TWITCH_ORDERS):
            context["create_order_url"] = reverse_lazy(
                f"internal:new-{Platform.TWITCH}"
            )
